...
{
    public partial class MatRestoreForm : Form
    {
        public MatRestoreForm()
        {
            InitializeComponent();
        }
        ...
        private string strMainMatName;//被拆物料编号
        private string Type;
      

        public MatRestoreForm(string type, string strReceiptId, string strmainMatName)
        {
            InitializeComponent();            
            this.strReceiptId = strReceiptId;
            this.strMainMatName = strmainMatName;
            this.Type = type;
        }
    
        private void InitDataGridView()
        {
            DataTable dt = MatSplitChildDAO.GetRestoreData(this.strReceiptId);
